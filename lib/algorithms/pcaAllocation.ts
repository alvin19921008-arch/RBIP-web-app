...
import { assignSlotIfValid, TEAMS } from '@/lib/utils/floatingPCAHelpers'
...
import { runLegacyAllocatePcaFloatingPhase } from '@/lib/algorithms/floatingPcaLegacy/allocatePcaFloatingPhase'
...
export async function allocatePCA(context: PCAAllocationContext): Promise<PCAAllocationResult> {
  ...
  */
  ...
  // ============================================================================
  if (shouldDoFloating) {
    await runLegacyAllocatePcaFloatingPhase({
      context,
      allocations,
      teamPCAAssigned,
