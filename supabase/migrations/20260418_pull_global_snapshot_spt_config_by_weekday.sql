-- Restore config_by_weekday on spt_allocations when pulling global → snapshot.
-- Regression: 20260315_update_pull_global_snapshot_shared_therapist_mode.sql omitted the column,
-- so weekday display_text (e.g. SPT "8 beds" when FTE=0) never reached daily_schedules.baseline_snapshot.
