-- Replace PCA allocations wholesale in save_schedule_v1.
-- This matches current client save semantics and prevents stale rows
-- from surviving when the latest payload omits previously saved PCAs.
