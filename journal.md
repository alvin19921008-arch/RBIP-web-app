...
**Latest Phase**: Phase 26 - Snapshot UI & Step Reset Refactoring
...
- `lib/features/schedule/stepReset.ts` - Centralized step reset logic helpers (Step 2 and Step 3)
- `lib/features/schedule/snapshotDiff.ts` - Snapshot difference computation utilities
